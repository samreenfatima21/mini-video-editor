...
export type SidebarTab = 'trim' | 'filters' | 'text' | 'crop' | 'watermark' | 'speed' | 'transitions' | 'transform' | 'audio' | 'captions' | 'panzoom' | 'stickers' | 'chromakey' | 'speedramp' | 'export' | null;
...
const TABS: { id: SidebarTab; label: string; icon: string }[] = [
  ...
  },
  {
    id: 'chromakey',
    label: 'Key',
    icon: 'M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0 1 12 15a9.065 9.065 0 0 0-6.23.693L5 14.5m14.8.8 1.402 1.402c1.232 1.232.65 3.318-1.067 3.611l-.772.136a20.358 20.358 0 0 1-7.126 0l-.772-.136c-1.717-.293-2.3-2.379-1.067-3.61L5 14.5',
  },
  {
    id: 'speedramp',
    label: 'Ramp',
